...
def convolve(image, kernel):
    ...
    # allocate the memory for the output image, taking care to 
    # "pad" the boarders of the input image so the spatial 
    ...
    # each (x,y)-coordinate from left-to-rigt and top-to-bottom
...
# to apply using both out custom 'convole' function and 
